...
namespace System
{
	[__DynamicallyInvokable, ClassInterface(ClassInterfaceType.None), ComDefaultInterface(typeof(_Type)), ComVisible(true)]
	[Serializable]
	public abstract class Type : MemberInfo, _Type, IReflect
	{
		...
		[DebuggerHidden, DebuggerStepThrough, TargetedPatchingOptOut("Performance critical to inline this type of method across NGen image boundaries")]
		...
		[__DynamicallyInvokable, ComVisible(true), TargetedPatchingOptOut("Performance critical to inline this type of method across NGen image boundaries")]
